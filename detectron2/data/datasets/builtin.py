...
_PREDEFINED_SPLITS_FEWSHOT = {
    "animal": {
        "animal_base_train": ("voc_day/images", "voc_day/base.json"),      # 48类
        "animal_novel_3shot": ("voc_day/images", "voc_day/finetune_3shot.json"),
        "animal_novel_5shot": ("voc_day/images", "voc_day/finetune_5shot.json"),
        "animal_novel_10shot": ("voc_day/images", "voc_day/finetune_10shot.json"), # 17类
        "animal_test_all": ("voc_day/images", "voc_day/test_300shot.json"),           # 65类
    }
}
